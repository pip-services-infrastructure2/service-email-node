...
var plugin = require('service-email-node').EmailSenecaPlugin;
...
or by using [EmailSenecaClient](https://github.com/pip-services-infrastructure2/client-email-node/NodeClientApiV1.md/#client_seneca)